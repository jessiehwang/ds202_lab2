...
# It identify all the countries which are in row 1, row 2, row 3, row 4, and row 5 have values not equal to 0. So it shows all the company locations which have review date from 2017 to 2017 with their index number.
